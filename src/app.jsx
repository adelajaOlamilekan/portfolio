...
const MMA_VALUES = [
  {
    icon: "🎯",
    label: "Discipline",
    desc: "Consistent practice, repetition, and attention to fundamentals.",
  },
  {
    icon: "🧠",
    label: "Composure",
    desc: "Staying calm under pressure and making deliberate decisions.",
  },
  {
    icon: "⚡",
    label: "Adaptability",
    desc: "Reading changing situations and adjusting strategy quickly.",
  },
  {
    icon: "📈",
    label: "Continuous Improvement",
    desc: "Reviewing mistakes, learning from them, and becoming better over time.",
  },
];
      ...
      >
        ...
        >
          ...
          >
            ...
            e-commerce, and embedded domains.
          </p>
...
<<<<<<< HEAD
              ...
              <p className="t-body" style={{ color: "rgba(232,237,232,.65)" }}>
                My work spans e-commerce, EdTech, SaaS, engineering
